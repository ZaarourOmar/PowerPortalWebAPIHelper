...
namespace PowerPortalWebAPIHelper.Models
{
    public static class Constants
    {
        ...
        public static string CREATE_ENTITY_PERMISSION_DIALOG = "This action will create a global table permission for the selected entity. This is the least restrictive table permission type so make sure to modify it based on your needs. The created permission will be associated with the \"Administrators\" web role (if found). Do you want to continue?";
        ...
        public static string WEBROLE_ADMIN_NOTFOUND = "The \"Administrators\" Webrole is not found for the selected website. The table permission will be created without a role attached to it and it needs to be done manually.";

        public static string UNABLE_TO_CREATE_ENTITY_PERMISSION = "Unable to create table permission, please restart the tool.";

        public static string ENTITY_PERMISSION_CREATED = "A table permission is created for the selected entity.";

        public static string ENTITY_HAS_NO_ENTITYPERMISSION = "The selected entity has no related active table permissions found. One is needed for the WebAPI calls to work.";

        public static string ENTITY_HAS_ENTITYPERMISSION = "An active table permission is found for the selected entity. Make sure it allows for the required API actions (Create, Write, Delete ...)";
