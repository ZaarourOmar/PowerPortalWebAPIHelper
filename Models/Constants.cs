...
namespace PowerPortalWebAPIHelper.Models
{
    public static class Constants
    {
        ...
        public static string ENTITY_HAS_ENTITYPERMISSION = "An active entity permission is found for the selected entity.";
    }
}
