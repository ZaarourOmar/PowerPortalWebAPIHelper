...
namespace PowerPortalWebAPIHelper
{
    public class MetadataValidator
    {
        ...
        // an attribute is valid if it has a display name and is available for odata endpoints
        public static bool IsValidAttribute(AttributeMetadata attributeMetadata)
        {
            return attributeMetadata.DisplayName.LocalizedLabels.Count > 0 && attributeMetadata.IsValidODataAttribute;
        }
